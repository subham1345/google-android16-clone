  ...
  return (
    <div className="page-layout" >
      <div className="main-card" >
        ...
        />
        <div className="card-details" style={{height:'100%',position:'relative'}}>
          <h2 id='circle-to-search'>Circle to Search</h2>
          <p id='circle-to-search-p'>
            Search anything on your Android phone with a simple gesture — like circling, highlighting, scribbling or tapping.
          </p>
        <div style={{bottom: "0", right: "0", position: "absolute", padding: "10px"}}>
          <FiExternalLink style={{ color: "#1a73e8", width: "24px", height: "24px" }} />
        </div>
        </div>
      </div>
      <div className="side-cards">
        <div className="side-card">
          ...
          <div className="card-details">
            ...
            <p>
              Be more productive with Gemini, built right into Gmail, Docs, Sheets and more.
            </p>
          </div>
        ...
        <div className="side-card">
          ...
          <div className="card-details">
            ...
            <p>
              Virtually explore a place in Maps, with details like weather and busyness to help you feel like you’re really there.
            </p>
          </div>
          <div style={{ marginLeft: "auto" }}>
            <FiExternalLink style={{ color: "#1a73e8", width: "24px", height: "24px" }} />
